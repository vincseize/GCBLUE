...
<body onload="initialize_types('<?php echo $id_type; ?>');">
    ...
    <!-- #my_account -->
    <div id="my_account" class="my_account">
        <form action="register_myaccount.php" method="post">
            <p>
            <input type="text" name="login" maxlength="25" placeholder="login">
            <input type="password" name="pass" id="password" placeholder="**********"/>
            <input type="submit" name="submit" id="submit" value="go to my account panel" class="my_log_input"/>
            </p>
        </form>
    </div>
    <!-- /#login_admin -->
    ...
    <!-- #login_admin -->
    <div id="login_admin" class="login_admin">
        <form action="register.php" method="post">
            <p>
            <input type="password" name="password" id="password" placeholder="**********"/>
            <input type="submit" name="submit" id="submit" value="go to admin panel" class="my_log_input"/>
            </p>
        </form>
    </div>
    <!-- /#login_admin -->
